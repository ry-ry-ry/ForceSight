// NATO APP-6A Symbol Library - Auto-generated from 3268 symbols
...
// Comprehensive NATO symbol database
export const NATO_SYMBOLS: NatoSymbolEntry[] = [
  ...
  {
    "code": "sfapmfqa",
    "name": "Airborne Special Operations",
    "category": "Air",
    "tags": [
      "friendly",
      "air",
  ...
  {
    "code": "sfapmfqm",
    "name": "Mechanized Special Operations",
    "category": "Air",
    "tags": [
      "friendly",
      "air",
  ...
  {
    "code": "sfapmfqs",
    "name": "Special Special Operations",
    "category": "Air",
    "tags": [
      "friendly",
      "air",
  ...
  {
    "code": "sfgpewsm",
    "name": "Mechanized Special Forces",
    "category": "Ground",
    "tags": [
      "friendly",
      "ground",
  ...
  {
    "code": "sfgpewtm",
    "name": "Mechanized Transportation",
    "category": "Ground",
    "tags": [
      "friendly",
      "ground",
...
// Size/echelon markers
export const SIZE_SYMBOLS: Record<string, { symbol: string; name: string }> = {
    'Team/Crew': { symbol: '•', name: 'Team' },
    'Squad': { symbol: '••', name: 'Squad' },
    'Section': { symbol: '•••', name: 'Section' },
    'Platoon': { symbol: '••••', name: 'Platoon' },
    'Company': { symbol: 'I', name: 'Company' },
    'Battery': { symbol: 'II', name: 'Battery' },
...
export function generateNatoSymbolSVG(code: string, affiliation: Affiliation, size: number = 100): string {
    ...
    // Build the SIDC with correct affiliation
    const sidcArray = sidc.split('');
    sidcArray[1] = affMap[affiliation];
    const fullSidc = sidcArray.join('');

    try {
        const symbol = new ms.Symbol(fullSidc, {
            size,
            fill: true,
            strokeWidth: 2,
        });
